...
class GNN11(nn.Module):
    def __init__(self, in_feats, h1_feats, num_classes, dropout=0):
        super(GNN11, self).__init__()
        self.conv1 = SAGEConv(in_feats, h1_feats, 'pool', feat_drop=dropout)
...
class GNN12(nn.Module):
    def __init__(self, in_feats, h1_feats, h2_feats, num_classes, dropout=0):
...
class GNN21(nn.Module):
    def __init__(self, in_feats, h1_feats, h2_feats, num_classes, dropout=0):
        ...
        self.conv1 = SAGEConv(in_feats, h1_feats, 'pool', feat_drop=dropout)
        self.conv2 = SAGEConv(h1_feats, h2_feats, 'pool', feat_drop=dropout)
...
class GNN22(nn.Module):
    def __init__(self, in_feats, h1_feats, h2_feats, h3_feats, num_classes, dropout=0):
